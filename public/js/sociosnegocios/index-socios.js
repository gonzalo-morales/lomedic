...
$(document).ready(function(){
    ...
    $(".itipo_socios option").each(function(k,v){
        // console.log(v);
        $(v).attr('selected',true);
        $(".itipo_socios").multiselect('refresh');
    });
...
//
// function _ajax_request(e,t,u,r,a){return jQuery.isFunction(t)&&(u=t,t={}),
// jQuery.ajax({type:a,url:e,data:t,success:u,dataType:r})}
// jQuery.extend({put:function(e,t,u,r){return _ajax_request(e,t,u,r,"PUT")},delete:function(e,t,u,r){return _ajax_request(e,t,u,r,"DELETE")}});
//
