...
<div class="col s12 xl8 offset-xl2">
	<div class="row">
		...
		<div class="col s6">
			<p class="right-align">
				<a href="{{ companyRoute('edit', ['company'=> $company, 'id' => $data->id_parentesco]) }}" class="waves-effect waves-light btn"><i class="material-icons right">mode_edit</i>Editar</a>
			</p>
		</div>
	</div>
...
<div class="col s12 xl8 offset-xl2">
	<div class="row">
		<div class="input-field col s4">
			<input type="text" name="parentesco" id="parentesco" class="validate" readonly value="{{ $data->nombre }}">
