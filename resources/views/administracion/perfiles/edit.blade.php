...
@section('content')
<div class="col-12">
	<h4 class="display-4">Editar {{ trans_choice('messages.'.$entity, 0) }}</h4>
</div>

<div class="col-12">
	<div class="row">
		<form action="{{ companyRoute("update", ['id' => $data->id_perfil,'company' => $company]) }}" method="post" class="container-fluid">
			{{ csrf_field() }}
			{{ method_field('PUT') }}
			<div class="col-12">
					...
					<div class="row">
						<div class="col-sm-12 col-md-7">
							<div class="form-group">
								...
								<input id="nombre_perfil" name="nombre_perfil" type="text" class="validate form-control" value="{{$data->nombre_perfil}}">
							</div>
						</div>
						<div class="col-sm-12 col-md-5">
							<label for="descripcion">Descripción:</label>
							<input id="descripcion" name="descripcion" type="text" class="validate form-control" value="{{$data->descripcion}}">
						</div>
					</div>
