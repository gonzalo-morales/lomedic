...
<div class="col s12 xl8 offset-xl2">
	<div class="row">
		<form action="{{ route("$entity.update", ['id' => $data->id_correo,'company' => $company]) }}" method="post" class="col s12">
			{{ csrf_field() }}
			{{ method_field('PUT') }}
			<div class="row">
				<div class="right">
				...
				<div class="col s12 m5">
					...
					<div class="row">
						<div class="input-field col s12 m7">
							<input id="nombre_perfil" type="text" class="validate" value="{{$data->nombre_perfil}}">
							<label for="nombre_perfil">Perfil:</label>
						</div>
						<div class="input-field col s12 m5">
							<input id="descripcion" type="text" class="validate" value="{{$data->descripcion}}">
