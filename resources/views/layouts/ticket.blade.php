...
<nav id="rigth-sidebar" class="bg-white">
    <div class="sidebar-header">
        ...
        <a href="{{companyAction("Soporte\SolicitudesController@create")}}" class="waves-effect waves-light btn-flat white-text dismiss"><span class='window'><span class='small'>Crear Ticket/Solicitud</span></span></a>
        </div>
    </div>
