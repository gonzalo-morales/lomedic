                                                ...
                                                @foreach($data->detalles->where('eliminar',0) as $row => $detalle)
                                                    <tr>
                                                        ...
                                                        @if(Route::currentRouteNamed(currentRouteName('edit')))
                                                            ...
                                                            <input type="hidden" name="relations[has][detalles][{{$row}}][id_detalle_vale]"  value="{{$detalle->id_detalle_receta}}"/>
                                                            <input type="hidden" name="relations[has][detalles][{{$row}}][fk_id_surtido_vale]"  value="{{$detalle->fk_id_surtido_receta}}"/>
