                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {{ Form::cText('Nombre del paciente', 'paciente',['disabled'])}}
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {{ Form::cText('Nombre del titular', 'titular',['disabled']) }}
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {{ Form::cText('Nombre del medico', 'medico',['disabled']) }}
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {{ Form::cText('Diagnostico', 'diagnostico',['disabled']) }}
                                    </div>
                                </div>
                                {{--<input type="hidden" id="fecha_captura" name="fecha_captura" value="{{date('Y-m-d H:i:s')}}">--}}
                                <input type="hidden" name="fk_id_usuario_captura" value="{{$fk_id_usuario_captura}}">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {{ Form::cText('Edad', 'edad',['disabled']) }}
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {{ Form::cText('Patente', 'patente',['disabled']) }}
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {{ Form::cText('Sexo', 'genero',['disabled']) }}
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        {{ Form::cText('Tipo usuario', 'parentesco',['disabled']) }}
                                    </div>
                                </div>
                            </div><!--/row forms-->
                        </div>
                    ...
                    @if(!Route::currentRouteNamed(currentRouteName('create')))
                        @if(isset($data->detalles))
                            @foreach($data->detalles->where('eliminar',0) as $row => $detalle)
                                <tr>
                                    <td>{{$detalle->claveClienteProducto->sku['sku']}}</td>
