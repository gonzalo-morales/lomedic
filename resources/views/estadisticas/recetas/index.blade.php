...
@section('header-bottom')
    ...
    <!-- Code Charts-->
    {{ HTML::script(asset('js/estadistica-recetas.js')) }}
...
<div class="container-fluid">
	<div class="panel shadow-3 panel-danger">
    	<div class="panel-heading">
    		<h3 class="panel-title text-center">Estad&#237;sticas de Recetas Medicas</h3>
    	</div>
    	<div class="panel-body">
            ...
            <div class="row">
            	<h3 class="text-danger text-center">Recetado vs Entregado</h3>
