	...
	<div class="row">
		<div class="col-sm-4">
			<div class="form-group" v-cloak>
				{{ Form::cSelectWithDisabled('Tipo de salida', '', $tipos_salida ?? [], [
					'v-select2' => 'tipo_salida',
					'v-model.number' => 'tipo_salida',
					'v-validate' => '"required|not_in:0"',
					'v-bind:class' => '{"is-invalid": errors.has("main.tipo_salida")}',
					'data-vv-as' => 'Tipo de salida',
					'data-vv-name' => 'tipo_salida',
					'data-vv-scope' => 'main',
				]) }}
                <span v-show="errors.has('main.tipo_salida')" class="help-block help-block-error small">@{{ errors.first('main.tipo_salida') }}</span>
			</div>
		</div>
		<div class="col-sm-4">
			<div class="form-group" v-cloak>
				{{ Form::cSelectWithDisabled('Cliente', 'fk_id_socio_negocio', $clientes ?? [], [
					'v-select2' => 'fk_id_socio_negocio',
		...
		<div class="col-sm-4">
			<div class="form-group" v-cloak>
				{{ Form::cSelectWithDisabled('Proyecto', '', $proyectos ?? [], [
					'ref' => 'fk_id_proyecto',
					'v-select2' => 'fk_id_proyecto',
		...
		<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-sm-6 col-lg-4">
					<div class="form-group" v-cloak>
						{{ Form::cSelectWithDisabled('Entrega por', '', [
							'1' => 'Empresa',
							'2' => 'Paquetería'
						], [
							'v-select2' => 'entrega_por',
				...
				<div class="col-sm-6 col-lg-8 vue-slide-fade" v-if="entrega_por == 2" key="x1">
					<div class="form-group" v-cloak>
				...
				<div class="col-sm-6 col-lg-8 vue-slide-fade" v-if="entrega_por == 1" key="x2">
					<div class="row">
						<div class="col-sm-6 col-lg-6">
							<div class="form-group" v-cloak>
								{{ Form::cText('Nombre de conductor', '', [
						...
						<div class="col-sm-6 col-lg-6">
							<div class="form-group" v-cloak>
								{{ Form::cText('Placas del vehiculo', '', [
		...
		<div class="col-sm-6 col-lg-4">
			<div class="form-group" v-cloak>
				{{ Form::cSelectWithDisabled('Tipo de entrega', '', $tipos_entrega ?? [], [
					'v-select2' => 'tipo_entrega',
					'v-model.number' => 'tipo_entrega',
					'v-validate' => '"required|not_in:0"',
					'v-bind:class' => '{"is-invalid": errors.has("main.tipo_entrega")}',
					'data-vv-as' => 'Tipo de salida',
					'data-vv-name' => 'tipo_entrega',
					'data-vv-scope' => 'main',
				]) }}
                <span v-show="errors.has('main.tipo_entrega')" class="help-block help-block-error small">@{{ errors.first('main.tipo_entrega') }}</span>
			</div>
		</div>
		<div class="col-sm-6 col-lg-4">
			<div class="form-group" v-cloak>
				{{ Form::cSelectWithDisabled('Sucursal de entrega', '', $sucursales_entrega ?? [], [
					'ref' => 'fk_id_direccion_entrega',
					'v-select2' => 'fk_id_direccion_entrega',
			...
			<div id="app" class="card z-depth-1-half">
				...
				<div class="card-body">
					...
					<table class="table table-hover table-responsive-sm table-striped" style="table-layout: fixed">
						...
						<tbody v-cloak name="list-complete" is="transition-group">
							<tr v-for="upc,index in upcs_computed" v-bind:class="{'list-complete-item':true,'table-dark':upc.eliminar}" v-bind:data-index.prop.camel="index" v-bind:key="upc.idx">
								<th scope="row">
							...
							<tr class="text-center" v-if="upcs.length == 0"  v-bind:key="'empty'">
