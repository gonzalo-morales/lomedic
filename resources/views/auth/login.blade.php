...
@section('title', cTrans('titles.login','Iniciar Sessi�n'))
    			...
    			<div class="container-fluid">
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						{{ Form::password('password', ['id'=>'password','class'=>'validate form-control','placeholder'=>'* '.cTrans('forms.password','Contrase�a')]) }}
    					</div>
    				...
    				<div class="form-group">
    					<small><a class='card-link text-white' href="{{ route('password.request') }}"><b>{{ cTrans('forms.fgpassword','�Olvidaste contrase�a?') }}</b></a></small>
    				</div>
    			</div>
			{!! Form::close() !!}
		</div><!--/card-->
