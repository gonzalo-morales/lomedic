...
<div class="container">
	...
	<div class="col-sm-10 col-md-8 col-lg-5 mt-5">
		<div class="card card-block text-center" style="background: rgba(0,0,0,0.3);"> <!-- class="card-panel hoverable row"> -->
        	<h4 class="mt-3 text-white">@lang('messages.welcome')</h4>
    			...
    			<div class="container-fluid">
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						{{ Form::text('usuario', $usuario ?? '', ['id'=>'usuario','class'=>'validate form-control','placeholder'=>'* '.trans('forms.user'),'autofocus'=>true]) }}
    					</div>
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						{{ Form::password('password', ['id'=>'password','class'=>'validate form-control','placeholder'=>'* '.trans('forms.password')]) }}
    					</div>
                            {{ $errors->has('password') ? HTML::tag('span', $errors->first('password'), ['class'=>'form-text text-white bg-danger p-1 m-0 rounded-bottom']) : '' }}
    				</div>
    				<div class="form-group">
    					<div class=" container">
    					{{ Form::button(trans('forms.login'), ['type' =>'submit', 'class'=>'btn btn-primary progress-button']) }}
    					</div>
    				</div>
    				<div class="form-group">
    					<small><a class='card-link text-white' href="{{ route('password.request') }}"><b>@lang('forms.fgpassword')</b></a></small>
    				</div>
    			</div>
			{!! Form::close() !!}
		</div><!--/card-->
