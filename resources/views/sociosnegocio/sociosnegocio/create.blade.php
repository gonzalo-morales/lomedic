			      ...
			      <div class="tab-content">
			            ...
			            <div class="card z-depth-0">
			                <div class="card-image">
			                    {{-- <form> --}}
									...
									{{-- <button type="button" id="xx">XX</button> --}}

			                        {{-- <button class="btn-floating btn-large orange halfway-fab waves-effect waves-light tooltipped hide"
			                                data-position="bottom" data-delay="50" data-tooltip="Guardar" type="submit" id="guardarCuenta" data-action="save"><i
			                                class="material-icons">save</i></button> --}}

											{{-- <div class="halfway-fab right">
			                ...
			                <div class="card-content">
			                    <table class="responsive-table highlight" id="tableCuentas">
			                        <thead>
			                        <tr>
			                            <th>Banco</th>
			        ...
			        <div id="info_entrega" class="tab-pane" role="tabpanel">
			            <div class="row">
							...
							@endforeach
			                    {{-- <p>
			                        <input name="tipos_entrega" type="radio" id="sucursal"/>
			                        <label for="sucursal">Sucursal</label>
			                    </p>
			                    <p>
			                        <input name="tipos_entrega" type="radio" id="paqueteria"/>
			                        <label for="paqueteria">Paquetería</label>
			                    </p>
			                    <p>
			                        <input name="tipos_entrega" type="radio" id="recoleccion"/>
			                        <label for="recoleccion">Recolección</label>
			                    </p> --}}
			                {{-- </form> --}}
							<div class="input-field col s12 m3" id="sucursalBlock" hidden="true">
			                ...
			                <div class="card-image">
			                    {{-- <form> --}}
			                        <div class="row">
			                            <div class="row">
			                                <div class="col s12 m3">
			                                    ...
			                                    <select id="tipo_contacto" name="tipo_contacto" class="custom-select">
			                                        <option value="" disabled selected>Selecciona...</option>
			                            ...
			                            <div class="input-field col s6 m3">
			                                <input id="telefono_oficina" name="telefono_oficina" type="tel" class="form-control">
			                                <label for="telefono_oficina">Teléfono:</label>
			                            </div>
			                            <div class="input-field col s6 m2">
			                                <input id="extension_oficina" name="extension_oficina" type="number" class="form-control">
			                        ...
			                        <button class="btn btn-primary btn-large tooltipped" style="width: 4em; height:4em; border-radius:50%;"
			                                ...
			                                class="material-icons">add</i></button>
									{{-- <button type="button" id="zz">Z</button> --}}
			                    {{-- </form><!--/Here ends de form--> --}}
			                    <div class="divider"></div>
			                </div><!--/Here ends the up section-->
			                <div class="card-content">
			                    <table class="responsive-table highlight" id="tableContactos">
			                        <thead>
			                        <tr>
			        ...
			        <div id="directions" class="tab-pane" role="tabpanel">
			            <div class="card z-depth-0">
			                    ...
			                    {{-- <form> --}}
			                        <div class="row">
			                            ...
			                            <div class="col s6 m3">
			                                ...
			                                <input type="text" id="colonia" class="autocomplete">
			                            </div>
			                        </div><!--/row-->
			                        <button class="btn btn-primary btn-large tooltipped" style="width: 4em; height:4em; border-radius:50%;"
			                ...
			                <div class="card-content">
			                    <table class="responsive-table highlight" id="tableDirecciones" name="tableDirecciones">
			                        <thead>
			                        <tr>
			                            <th>Tipo</th>
			        ...
			        <div id="licencias" class="tab-pane" role="tabpanel">
			            ...
			            <div class="col s12 m4">
			                <div class="card z-depth-0">
			                                ...
			                                <label>Licencia Sanitaria</label>
			                                    <div class="file-field input-field">
			                                      <div class="btn">
			                                        ...
			                                        <input type="file" multiple id="filesSanitarias" {{-- data-url="{{companyAction('SociosNegocio\SociosNegocioController@uploadLicencias')}}" --}}>
												  </div>
			                    ...
			                    <div class="card-content">
			                        <table class="responsive-table highlight" id="tableSanitaria" name="tableSanitaria">
			                            <thead>
			                            <tr>
			                                <th>Licencia(s)</th>
			                            </tr>
			            ...
			            <div class="col s12 m4">
			                <div class="card z-depth-0">
			                            ...
			                            <div class="row">
			                                ...
			                                <label>Aviso de Funcionamiento</label>
			                                    <div class="file-field input-field">
			                                      <div class="btn">
			                                        <i class="material-icons">attach_file</i>
			                                        <input type="file" multiple id="filesAvisoFuncionamiento" >
			                                      </div>
			                                      <div class="file-path-wrapper">
			                                        <input class="file-path validate" type="text">
			                                      </div>
			                    ...
			                    <div class="card-content">
			                        <table class="responsive-table highlight" id="tableAvisosFuncionamiento">
			                            <thead>
			                            <tr>
			                                <th>Aviso(s)</th>
			                            </tr>
			            ...
			            <div class="col s12 m4">
			                <div class="card z-depth-0">
			                        ...
			                        <form>
			                            <div class="row">
			                                ...
			                                <label>Aviso de Responsable Sanitario</label>
			                                    <div class="file-field input-field" id="avisoRespToClone">
			                                      <div class="btn">
			                                        <i class="material-icons">attach_file</i>
			                                        <input type="file" multiple id="filesAvisoResponsable">
			                                      </div>
			                                      <div class="file-path-wrapper">
			                                        <input class="file-path validate" type="text">
			                                      </div>
			                    ...
			                    <div class="card-content">
			                        <table class="responsive-table highlight" id="tableAvisosResponsable">
			                            <thead>
			                            <tr>
			                                <th>Aviso(s)</th>
			                            </tr>
