...
?>
  ...
  <html>
    ...
    <div class="animation-container">
          <h3 class="center white-text">Error The page has expired due to inactivity.</h3>
          <h6 class="center white-text">Please refresh and try again. <b><a class="orange-text" href="{{ $Url }}">Clic aquí para volver</a></b><br></h6>
