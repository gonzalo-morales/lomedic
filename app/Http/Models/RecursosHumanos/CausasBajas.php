...
class CausasBajas extends ModelBase
{
    use Notifiable;
    /**
     ...
     * @var string
     */
    protected $table = 'maestro.rh_cat_causas_bajas';

    /**
     * The primary key of the table
     * @var string
     */
    protected $primaryKey = 'id_causa_baja';
     ...
     * @var array
     */
    protected $fillable = ['causa_baja','activo'];
     ...
     */
    public $rules = [
        'causa_baja' => 'required|max:100|regex:/^([0-9a-zA-ZÃ±Ã‘Ã¡Ã©Ã­Ã³ÃºÃ�Ã‰Ã�Ã“Ãš_-])+((\s*)+([0-9a-zA-ZÃ±Ã‘Ã¡Ã©Ã­Ã³ÃºÃ�Ã‰Ã�Ã“Ãš_-]*)*)+$/',
