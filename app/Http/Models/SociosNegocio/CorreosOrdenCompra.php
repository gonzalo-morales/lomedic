...
class CorreosOrdenCompra extends Model
{
    // use SoftDeletes;
     ...
     * @var string
     */
    protected $table = 'sng_det_correos_orden_compra';
     ...
     * @var array
     */
    protected $fillable = ['fk_id_socio_negocio','correo','activo'];
    /**
    ...
    public function socioNegocio(){
       return $this->belongsTo('App\Http\Models\SociosNegocio\SocioNegocio', 'fk_id_socio_negocio');
    }
}
