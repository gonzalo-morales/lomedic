...
class NotasCreditoProveedorController extends ControllerBase
{
	...
	public function getDataView($entity = null)
    {
        ...
        return [
            ...
            'relaciones' => TiposRelacionesCfdi::select(db::raw("concat('(',tipo_relacion,') ',descripcion) as text"),'id_sat_tipo_relacion')->activos()->where('nota_credito',1)->pluck('text','id_sat_tipo_relacion')->prepend('...',0),
