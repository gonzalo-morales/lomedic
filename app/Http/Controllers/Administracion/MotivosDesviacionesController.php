...
class MotivosDesviacionesController extends Controller
{
	...
	public function store(Request $request, $company)
	{
		...
		if($created){
			Logs::createLog($this->entity->getTable(),$company,$created->id_motivo_desviacion,'crear','Registro insertado');
		}else{
