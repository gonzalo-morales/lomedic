...
use App\Http\Models\Administracion\MotivosAjustes;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Route;
use App\Http\Models\Logs;

class MotivosAjustesController extends Controller
{
	 ...
	 * @return void
	 */
	public function __construct(MotivosAjustes $entity)
	{
		$this->entity = $entity;
	...
	public function store(Request $request, $company)
	{
		...
		if($created){
			Logs::createLog($this->entity->getTable(),$company,$created->id_motivo_ajuste,'crear','Registro insertado');
		}else{
