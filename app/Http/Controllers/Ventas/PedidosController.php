...
class PedidosController extends ControllerBase
{
    ...
    public function getDataView($entity = null)
    {
        ...
        return [
            ...
            'sucursales' => /*empty($entity) ? [] :*/ Sucursales::select('sucursal','id_sucursal')->isActivo()->hasEmpresa()->hasUsuario()/*->where('fk_id_cliente', $entity->fk_id_socio_negocio)*/->pluck('sucursal','id_sucursal'),
            'js_sucursales' => Crypt::encryptString('"select": ["sucursal", "id_sucursal"], "isActivo":[], "hasEmpresa":[], "hasUsuario":[], "conditions": [{"where": ["fk_id_cliente","$fk_id_cliente"]}, {"where": ["fk_id_localidad","$fk_id_localidad"]}], "orderBy": [["sucursal", "ASC"]]'),
