...
class NotasCreditoClientesController extends ControllerBase
{
	...
	public function getDataView($entity = null)
    {
        return [
            ...
            'notascargorelacionadas'=>NotasCargoClientes::selectRaw("CONCAT(serie,'-',folio,'  [',uuid,']') as notacargo, id_documento")->whereNotNull('uuid')->orderBy('notacargo')->pluck('notacargo','id_documento')->prepend('...','0'),
