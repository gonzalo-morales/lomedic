...
class SociosNegocioController extends ControllerBase
{
	...
	public function getDataView($entity = null)
	{
	    ...
	    return [
	        'ramos'                => Ramos::where('activo',1)->pluck('ramo','id_ramo')->sortBy('ramo')->prepend('Selecciona una opcion...',''),
	        'ejecutivos'           => Usuarios::where('activo',1)->pluck('nombre_corto','id_usuario')->sortBy('nombre_corto')->prepend('Selecciona una opcion...',''),
	        'paises'               => Paises::where('activo',1)->pluck('pais','id_pais')->sortBy('pais')->prepend('Selecciona una opcion...',''),
	        'tiposproveedores'     => TiposProveedores::where('activo',1)->pluck('tipo_proveedor','id_tipo_proveedor')->sortBy('tipo_proveedor')->prepend('Selecciona una opcion...',''),
	        ...
	        'tiposanexos'          => TiposAnexos::where('activo',1)->pluck('tipo_anexo','id_tipo_anexo')->sortBy('tipo_anexo')->prepend('Selecciona una opcion...',''),
	        'empresas'		       => Empresas::select('id_empresa','nombre_comercial')->where('activo',1)->where('empresa',1)->get()->sortBy('nombre_comercial'),
	        'condicionpago'        => CondicionesPago::where('activo',1)->pluck('condicion_pago','id_condicion_pago')->sortBy('condicion_pago')->prepend('Selecciona una opcion...',''),
	        ...
	        'bancos'               => Bancos::where('activo',1)->pluck('banco','id_banco')->sortBy('banco')->prepend('Selecciona una opcion...',''),
	        'sucursales' 	       => Sucursales::where('activo',1)->pluck('sucursal','id_sucursal')->sortBy('sucursal')->prepend('Selecciona una opcion...',''),
	        'tiposcontactos'       => TiposContacto::where('activo',1)->pluck('tipo_contacto','id_tipo_contacto')->sortBy('tipo_contacto')->prepend('Selecciona una opcion...',''),
	        'tiposdireccion'       => TiposDireccion::where('activo',1)->pluck('tipo_direccion','id_tipo_direccion')->sortBy('tipo_direccion'),
	        'skus'                 => Productos::where('activo',1)->pluck('sku','id_sku')->sortBy('sku')->prepend('Selecciona una opcion...',''),
